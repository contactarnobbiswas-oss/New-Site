...
export default function Footer() {
  const socialIcons = [
    ...
    { 
      name: 'Twitter X', 
      link: '#!', 
      svg: <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932L18.901 1.153zm-1.291 19.492h2.039L6.486 3.24H4.298l13.312 17.405z"/>
    },
    { 
      name: 'YouTube', 
      link: '#!', 
